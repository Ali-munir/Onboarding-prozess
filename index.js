...
const personalAccessToken = '1/1203140742610165:33fe82ed9fba0faa894e2e1a2c11ee1a';
...
client.users.me()
  .then(function (me) {
    console.log('Connection with Asana was successful ' + 'Wellcome ' + me.name + '!');
  });

client.projects.getProject(1203140703561345, { param: "value", param: "value", opt_pretty: true })
  .then((result) => {
    console.log(result);
  });
client.projects.createProjectForWorkspace(1203140742610175, { name: "test1", pretty: true })
  .then((result) => {
    console.log(result);
  });

client.tasks.getTasksForProject(1203140703561345, { param: "value", param: "value", opt_pretty: true })
  .then((result) => {
    console.log(result);
  });
